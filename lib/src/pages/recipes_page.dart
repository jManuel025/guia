        ...
        children: <Widget>[
          Table(children: [
            TableRow(children: [
              _tarjeta(
                  'Desayuno',
                  'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F44%2F2019%2F08%2F26232310%2F6183602.jpg&q=85',
                  context,
                  'recipes_list',
                  'free_breakfast',
                  'Desayuno'),
            ...
            TableRow(children: [
              _tarjeta(
                  'Cena',
                  'https://cdn-image.foodandwine.com/sites/default/files/1560953596/teriyaki-chicken-bowl-panera-dinner-menu-FT-BLOG0619.jpg',
                  context,
                  'recipes_list',
                  'brightness_2',
                  'Cena'),
              _tarjeta(
                  'Bebidas',
                  'https://www.nexgenus.com/Portals/1/xBlog/uploads/2019/4/22/Coolers-powdered-soft-drink-800-800x800.png',
                  context,
                  'recipes_list',
                  'local_drink',
                  'Bebidas'),
            ...
            TableRow(children: [
              _tarjeta(
                  'Ensaladas',
                  'https://citelis.com.mx/uploads/c114e99ccd3b0631db97d0ccbc12e13c.jpg',
                  context,
                  'recipes_list',
                  'healing',
                  'Ensaladas'),
              _tarjeta(
                  'Postres',
                  'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fcdn-image.foodandwine.com%2Fsites%2Fdefault%2Ffiles%2FHD-200912-r-raspberry-macarons.jpg&w=400&q=85',
                  context,
                  'recipes_list',
                  'cake',
                  'Postres'),
...
Widget _tarjeta(String texto, String rutaImagen, BuildContext context,
    String pantalla, String icono, String categoria) {
  return Container(
      height: 145.0,
        ...
        child: Stack(
          ...
          children: <Widget>[
            ...
            TextButton(
              child: SizedBox(),
              onPressed: () =>
                  Navigator.pushNamed(context, pantalla, arguments: categoria),
            ),
          ],
        ),
      ));
